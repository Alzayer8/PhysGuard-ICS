...
- Clean, installable public package with transparent anomaly and physics scoring.
- Immutable experiment workspaces with automatically generated identifiers.
...
- No external datasets, sealed studies, prior outputs, checkpoints, or local development
  state are present in the public release.
